...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        // No `field-sizing-content`: it sizes the textarea to its content and silently
        // neutralizes the native resize grip (the prompt "expander" did nothing).
        // Classic sizing keeps drag-to-resize working wherever a field sets `resize-y`.
